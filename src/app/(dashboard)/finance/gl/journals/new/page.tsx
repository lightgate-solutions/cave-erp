...
import { createJournal } from "@/actions/finance/gl/journals";
...
export default function NewJournalPage() {
  ...
  const [lines, setLines] = useState<JournalLine[]>([
    { id: 1, accountId: "", description: "", debit: "0.00", credit: "0.00" },
    { id: 2, accountId: "", description: "", debit: "0.00", credit: "0.00" },
  ]);
  ...
  const handleSubmit = (post: boolean) => {
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        toast.success(
          post
            ? `Journal ${result.journalNumber} created and posted`
            : `Journal ${result.journalNumber} saved as draft`,
        );
