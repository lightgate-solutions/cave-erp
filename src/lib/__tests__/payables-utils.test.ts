...
describe("payables-utils", () => {
    ...
    describe("calculateDuplicateSimilarity", () => {
        it("should return 0 for different vendors", () => {
            const bill1 = { vendorId: 1, vendorInvoiceNumber: "INV-001", total: "1000", billDate: "2024-03-01" };
            const bill2 = { vendorId: 2, vendorInvoiceNumber: "INV-001", total: "1000", billDate: "2024-03-01" };
        ...
        it("should return high score for exact match", () => {
            const bill1 = { vendorId: 1, vendorInvoiceNumber: "INV-001", total: "1000", billDate: "2024-03-01" };
            const bill2 = { vendorId: 1, vendorInvoiceNumber: "INV-001", total: "1000", billDate: "2024-03-15" };
        ...
        it("should detect partial invoice number match", () => {
            const bill1 = { vendorId: 1, vendorInvoiceNumber: "INV-001", total: "1000", billDate: "2024-03-01" };
            const bill2 = { vendorId: 1, vendorInvoiceNumber: "INV-001-A", total: "1000", billDate: "2024-03-01" };

            const result = calculateDuplicateSimilarity(bill1, bill2);
            expect(result.reasons.some(r => r.includes("Partial invoice"))).toBe(true);
        });

        it("should detect similar amounts within 1% tolerance", () => {
            const bill1 = { vendorId: 1, vendorInvoiceNumber: "INV-001", total: "1000", billDate: "2024-03-01" };
            const bill2 = { vendorId: 1, vendorInvoiceNumber: "INV-002", total: "1005", billDate: "2024-03-01" };

            const result = calculateDuplicateSimilarity(bill1, bill2);
            expect(result.reasons.some(r => r.includes("Similar amounts"))).toBe(true);
        });
    });
    ...
    describe("calculateStringSimilarity", () => {
        ...
        it("should return high similarity for similar strings", () => {
            const similarity = calculateStringSimilarity("Office Supplies", "Office Supply");
